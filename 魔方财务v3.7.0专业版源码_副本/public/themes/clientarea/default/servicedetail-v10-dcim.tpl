      ...
      <div class="card-top">
          ...
          <div class="operation-row2">
            ...
            <div class="row2-right" v-show="hostData.status == 'Active' && !initLoading">
              ...
              <span class="refund" v-if="financeConfig.cancel_control">
                ...
                <span class="refund-stop-btn" v-if="refundData.is_cancel" @click="quitRefund">{{lang.common_cloud_btn8}}</span>
        ...
        <div class="refund-msg">
          ...
          <div class="refund-success" v-if="refundData && refundData.status == 'Suspending'">
            ...
            {{refundData.type=='Expire'?lang.common_cloud_tip8:lang.common_cloud_tip9}}，{{lang.common_cloud_tip13}}<span v-if="refundData.type=='Expire'">{{hostData.due_time | formateTime}}</span> {{refundData.type=='Expire'?
            ...
            <div class="l-b">
                ...
                <div class="row-r">
                  ...
                  <div class="value">
                    ...
                    <i class="el-icon-document-copy"
                      style="font-size: .14rem; margin-left: .03rem; cursor: pointer; color: #0052D9;"
              ...
              <div class="row">
                ...
                <div class="row-m" v-else>
                  ...
                  <div class="value">{{cloudData.bw === 'NC' ? lang.actual_bw : (cloudData.bw + 'Mbps') }}</div>
                </div>
                <div class="row-r">
        ...
        <el-tabs class="tabs" v-model="activeName" @tab-click="handleClick" v-show="hostData.status == 'Active' && !initLoading">
          ...
          <el-tab-pane :label="lang.common_cloud_tab4" name="4" v-if="cloudConfig.manual_resource === 0">
            <div class="net">
              ...
              <div class="main_table">
                ...
                <pagination :page-data="netParams" v-if="netParams.total" @sizechange="netSizeChange" @currentchange="netCurrentChange">
                </pagination>
              </div>
          ...
          <el-tab-pane :label="lang.common_cloud_tab6" name="6">
            <div class="log">
              <div class="main_table">
                ...
                <pagination :page-data="logParams" v-if="logParams.total" @sizechange="logSizeChange" @currentchange="logCurrentChange">
                </pagination>
              </div>
            </div>
          </el-tab-pane>
          ...
          <el-dialog width="620px" :visible.sync="isShowReinstallDialog" :show-close=false @close="reinstallDgClose">
            ...
            <div class="dialog-main">
              ...
              <div class="pass-content">
                ...
                <el-input class="pass-input" v-model="reinstallData.password" :placeholder="lang.ticket_label12" v-show="reinstallData.type=='pass'">
              ...
              <template v-if="cloudConfig.reinstall_sms_verify === 1">
                ...
                <el-input class="pass-input" v-model="reinstallData.code" :placeholder="lang.account_tips33">
                  ...
                  <div class="pass-btn" slot="suffix" v-loading="sendFlag" @click="sendCode" v-else>{{lang.account_tips55}}</div>
                </el-input>
              </template>
              ...
              <div class="pay-img" v-show="isPayImg">
                ...
                <el-popover placement="top-start" width="200" trigger="hover">
                  <div class="show-config-list">{{lang.shoppingCar_tip_text2}}：{{commonData.currency_prefix}}{{ payDiscount }}</div>
                  <div class="show-config-list">{{lang.common_cloud_text28}}：{{commonData.currency_prefix}}{{ payCodePrice }}</div>
        ...
        <!-- 加入安全组 -->
        <el-dialog width="680px" :visible.sync="safeDialogShow" :show-close=false @close="safeClose" class="safe-dialog">
              ...
              <div class="pay-content">
                <div class="pay-price">
                  <div class="money" v-loading="renewLoading">
                    ...
                    <el-popover placement="top-start" width="200" trigger="hover" v-if="(isShowLevel && renewParams.clDiscount*1 > 0) || (isShowPromo && renewParams.isUseDiscountCode) || ( isShowCash && renewParams.customfield.voucher_get_id)">
                      <div class="show-config-list">
                        ...
                        <p v-if="isShowCash && renewParams.customfield.voucher_get_id">
                          {{lang.common_cloud_text29}}：{{commonData.currency_prefix}} {{ renewParams.cash_discount | filterMoney}}</p>
                      </div>
                      <i class="el-icon-warning-outline total-icon" slot="reference"></i>
                    </el-popover>
                    <p class="original-price" v-if="renewParams.customfield.promo_code && renewParams.totalPrice != renewParams.base_price">
                      {{commonData.currency_prefix}} {{ renewParams.base_price | filterMoney}}</p>
                    <p class="original-price" v-if="!renewParams.customfield.promo_code && renewParams.totalPrice != renewParams.original_price">
                    ...
                    <div class="code-number-text">
                      <div class="discount-codeNumber" v-show="renewParams.customfield.promo_code">{{
                        renewParams.customfield.promo_code }}<i class="el-icon-circle-close remove-discountCode" @click="removeRenewDiscountCode()"></i></div>
        ...
        <!-- 新增VPC网络 -->
        <el-dialog width="680px" :visible.sync="isShowAddVpc" :show-close=false @close="addVpcClose" class="addVpc-dialog">
        ...
        <!-- 分配主机 -->
        <el-dialog width="680px" :visible.sync="isShowengine" :show-close=false @close="engineClose" class="engine-dialog">
            ...
            <div class="dialog-main">
              ...
              <div class="engine-main-card">
                <div class="engine-box">
                  ...
                  <el-select v-model="engineID" clearable filterable remote reserve-keyword :placeholder="lang.common_cloud_title38" :remote-method="remoteMethod" :loading="engineSearchLoading">
        ...
        <el-dialog width="680px" :visible.sync="isShowIp" :show-close=false @close="ipClose" class="ip-dialog">
          ...
          <div class="dialog-main">
            <div class="label">{{lang.common_cloud_title40}} {{netDataList.length}} {{lang.common_cloud_title43}},{{lang.common_cloud_title45}}</div>
          ...
          <div class="dialog-footer">
            ...
            <span class="num" v-loading="ipPriceLoading">
              ...
              <el-popover placement="top-start" width="200" trigger="hover">
                <div class="show-config-list">{{lang.common_cloud_text27}}：{{commonData.currency_prefix}}{{ ipDiscountkDisPrice }}</div>
                <div class="show-config-list">{{lang.common_cloud_text28}}：{{commonData.currency_prefix}}{{ ipCodePrice }}</div>
                <i class="el-icon-warning-outline total-icon" slot="reference" v-if="isShowLevel || isShowPromo"></i>
              </el-popover>
            </span>
          ...
          <el-dialog width="680px" :visible.sync="isShowRescue" :show-close=false @close="rescueDgClose">
            ...
            <div class="dialog-main">
              ...
              <el-select class="os-select" v-model="rescueData.type">
                <img class="os-img" :src="'/themes/clientarea/default/v10/img/' + (rescueData.type==1?'Windows':'Linux') + '.svg'" slot="prefix" alt="">
          ...
          <el-dialog width="950px" :visible.sync="isShowUpgrade" :show-close=false @close="upgradeDgClose">
            ...
            <div class="dialog-main">
              <el-form ref="orderForm" label-position="left" label-width="100px" hide-required-asterisk>
                <!-- IP数量 -->
                <el-form-item :label="lang.common_cloud_title15">
                  <el-radio-group v-model="ipName" @input="changeIp($event)">
                    <el-radio-button :label="calcIpUnit(c.value)" v-for="(c,cInd) in calcIPList" :key="cInd">
                    </el-radio-button>
                  </el-radio-group>
                </el-form-item>
                <!-- 带宽 -->
                <el-form-item :label="lang.mf_bw" v-if="lineDetail.bill_type === 'bw' && lineDetail.bw.length > 0">
                  ...
                  <el-radio-group v-model="bwName" v-if="lineDetail.bw[0].type === 'radio'" @input="changeBw">
                    <el-radio-button :label="c.value === 'NC' ? lang.actual_bw : (c.value + 'M')" v-for="(c,cInd) in lineDetail.bw" :key="cInd">
                    </el-radio-button>
                  </el-radio-group>
                  <!-- 拖动框 -->
                ...
                <div class="money" v-loading="upgradePriceLoading">
                  ...
                  <el-popover placement="top-start" width="200" trigger="hover" v-if="isShowLevel || (isShowPromo && upParams.isUseDiscountCode) || isShowCash">
                    <div class="show-config-list">
                      ...
                      <p v-if="isShowPromo && upParams.isUseDiscountCode">
                        ...
                        filterMoney}}</p>
                      <p v-if="isShowCash && upParams.customfield.voucher_get_id">{{lang.shoppingCar_tip_text5}}：{{commonData.currency_prefix}}
                        {{ upParams.cash_discount | filterMoney}}</p>
                    </div>
                    <i class="el-icon-warning-outline total-icon" slot="reference"></i>
                  </el-popover>
                  <p class="original-price" v-if="upParams.totalPrice != upParams.original_price">
                    {{commonData.currency_prefix}} {{ upParams.original_price | filterMoney}}</p>
                  <!-- <div class="code-box">
                  ...
                  <div class="code-number-text">
                    <div class="discount-codeNumber" v-show="upParams.customfield.promo_code">{{
                      upParams.customfield.promo_code }}<i class="el-icon-circle-close remove-discountCode" @click="removeUpDiscountCode()"></i></div>
        ...
        <!-- 购买流量包 -->
        <flow-packet :id="id" :show-package="showPackage" @cancledialog="cancleDialog" v-if="showPackage" :currency_prefix="commonData.currency_prefix" @sendPackId="handlerPay">
        </flow-packet>
      </div>
    </div>
  </div>
