      ...
      <div class="card-top">
          ...
          <div class="msg-l">
            ...
            <div class="l-b">
              ...
              <div class="row">
                ...
                <div class="row-r">
                  <div class="label" v-if="cloudData.ssh_key?.id > 0">{{lang.security_tab1}}:</div>
              ...
              <div class="row">
                <div class="row-l">
                  ...
                  <div class="value">{{rescueStatusData.ip_num}}{{lang.mf_one}}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <el-tabs class="tabs" v-model="activeName" @tab-click="handleClick"
          ...
          <el-tab-pane :label="lang.common_cloud_tab3" name="3">
            ...
            <span v-show="dataDiskList.length > 0 && !isPackage" class="buy-btn" @click="showDg">{{lang.common_cloud_btn22}}</span>
          </el-tab-pane>
          <el-tab-pane :label="lang.common_cloud_tab4" name="4">
            <div class="net">
              <div class="title top-box">
                <span>{{lang.common_cloud_title3}}</span>
                <div class="flow-btn" type="primary" @click="showIpDia" v-if="!isPackage">{{lang.common_cloud_title18}}</div>
              </div>
        ...
        <el-dialog width="680px" :visible.sync="isShowIp" :show-close=false @close="ipClose" class="ip-dialog">
          ...
          <div class="dialog-footer">
            ...
            <span class="num" v-loading="ipPriceLoading">
              {$Detail.currency.prefix}{{ipMoney >=0 ? ipMoney : 0}}
              <el-popover placement="top-start" width="200" trigger="hover">
                <div class="show-config-list">{{lang.common_cloud_text27}}：{$Detail.currency.prefix}{{
                  ipDiscountkDisPrice }}</div>
                <div class="show-config-list">{{lang.common_cloud_text28}}：{$Detail.currency.prefix}{{ ipCodePrice }}
                </div>
                <i class="el-icon-warning-outline total-icon" slot="reference" v-if="isShowLevel || isShowPromo"></i>
              </el-popover>
            </span>
        ...
        <div class="upgrade-dialog">
          <el-dialog width="950px" :visible.sync="isShowUpgrade" :show-close=false @close="upgradeDgClose">
            ...
            <div class="dialog-main">
              <!-- 自定义 -->
              <el-form ref="orderForm" label-position="left" label-width="100px" hide-required-asterisk v-if="!isPackage">
                <!-- cpu -->
                ...
                <div class="cur-package">
                  ...
                  <div class="cloud-item active">
                    ...
                    <div class="info">
                      ...
                      <p><span
                          class="name">IP{{lang.shoppingCar_goodsNums}}：</span>{{recommend_config.ip_num}}{{lang.common_cloud_title43}}
                      </p>
                    </div>
                  </div>
                </div>
