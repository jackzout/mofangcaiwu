    ...
    <div class="main-card mf-cloud" v-loading="loadingPrice && isInit">
      <el-tabs v-model="activeName" @tab-click="handleClick" class="top-tab">
                ...
                <div class="cloud-box" v-if="recommendList.length > 0">
                  <div class="cloud-item" :class="{active: index=== cloudIndex}" v-for="(item,index) in recommendList"
                    ...
                    <div class="info">
                      ...
                      <p class="no-up" v-if="item.upgrade_range === 0">
                        <span>{{lang.no_upgrade}}</span>
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <el-form-item label=" ">
                        <p class="s-tip jump-box">{{lang.mf_tip17}}&nbsp;&nbsp;
                          <a href="security_ssh.htm" target="_blank" class="add-ssh">
                            {{lang.mf_tip18}}
                            <img src="/plugins/reserver/mf_cloud/template/clientarea/img/common/jump.svg" alt=""
                              class="icon">
                          </a>
                        </p>
                      </el-form-item>
        ...
        <el-tab-pane :label="lang.custom_config" name="custom" :lazy="true"
          v-if="isUpdate ? activeName === 'custom' :  true">
          <div class="con">
            <p class="com-tit">{{lang.basic_config}}</p>
            <el-form :model="params" :rules="rules" ref="orderForm" label-position="left" label-width="100px"
              ...
              <el-form-item :label="lang.cloud_menu_3" v-if="activeName === 'custom'" class="store-item">
                    ...
                    <template slot-scope="{row}">
                      ...
                      <template v-else>
                        <el-input :value="lang.mf_no" disabled
                          v-if="row.index === 1 && baseConfig.free_disk_switch === 1" class="dis-input"></el-input>
                        <template v-else>
                ...
                <div class="store" v-if="(this.storeList.length < this.baseConfig.disk_limit_num + 1) && dataDiskList.length > 0">
              ...
              <template v-if="params.network_type === 'vpc'">
                ...
                <el-form-item :label="lang.common_cloud_title3" v-if="!params.nat_acl_limit_enable && !params.nat_web_limit_enable">
                  {{lang.mf_tip23}}
                </el-form-item>
              </template>
              <!-- 线路 -->
            ...
            <div class="bot-price" v-loading="loadingPrice">
              ...
              <div class="old">
                ...
                <el-popover placement="top" trigger="click" popper-class="discount-pup" v-model="dis_visible"
                  v-if="!discount">
                  <div class="discount">
                    <img src="/plugins/server/mf_cloud/template/clientarea/img/common/close_icon.png" alt=""
