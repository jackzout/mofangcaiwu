        ...
        <el-form :model="params" :rules="rules" ref="orderForm" label-position="left" label-width="100px"
          ...
          <el-form-item :label="lang.mf_bw" v-if="lineDetail.bill_type === 'bw' && lineDetail.bw.length > 0">
            ...
            <el-radio-group v-model="bwName" v-if="bwType === 'radio'" @input="changeBw">
              <el-radio-button :label="c.value === 'NC' ? lang.actual_bw : (c.value + 'M')" v-for="(c,cInd) in calcBwList" :key="cInd"
            ...
            <div class="image-box">
              <div class="image-ul">
                <div class="image-item" v-for="(item,index) in calcImageList" :key="item.id"
                  :class="{hover: curImage===index, active: imageName === item.name}" @click="changeImage(item,index)" @mouseenter="mouseenter(index)"
                  @mouseleave="hover = false">
                  <img :src="`/themes/clientarea/default/v10/img/${item.icon}.svg`" alt=""
                    class="icon" />
                  <div class="r-info">
                ...
                <div class="empty-image" :class="{isHide: !isHide}" @click="isHide = !isHide" v-show="imageList.length > 5">
            ...
            <div class="bot-price" v-loading="loadingPrice">
              ...
              <div class="old">
                ...
                <el-popover placement="top" trigger="click" popper-class="discount-pup" v-model="dis_visible"
                  v-if="!discount">
                  <div class="discount">
                    <img src="/plugins/server/mf_dcim/template/clientarea/img/common/close_icon.png" alt="" class="close"
